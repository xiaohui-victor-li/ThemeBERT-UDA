# Util helper functions for QesNLP library
# ----------------------------------------
# -latest@10/19/2022; inception@10/13/2022
#
#
import numpy as np
import logging
...
class NLPLogger:
    def __init__(self, level, name='FinNLP'):
    ...
    def write_local_log(self, file_name):
        """write local file to keep track of the log"""
        self.file_handler = logging.FileHandler('{}.log'.format(file_name))
