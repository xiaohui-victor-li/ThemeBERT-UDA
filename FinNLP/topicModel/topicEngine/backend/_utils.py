...
def select_backend(embedding_model,
    ...
    if "BertModel" in str(type(embedding_model)) or (embedding_model in ['E5-small']):
        return TransformerEmbedder(embedding_model)
